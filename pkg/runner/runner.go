...
func (r *SimpleRunner) probeBaseline(urlTemplate string) *baselineResult {
        ...
        // Consistent byte size — strongest signal.
        // All 3 random-path probes returning the same number of bytes is the
        // clearest possible indicator of a catch-all server (SPA fallback, CDN
        // cached landing page, marketing redirect, etc.).  Use it as the baseline.
        allSameSize := true
